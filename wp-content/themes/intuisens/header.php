...
<head>
	...
	<link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/images/devices/reve.rie-icon-retina.png" />
...
<body <?php body_class(); ?>>
	...
	<div id="container" class="container" role="document">
		...
		<header role="banner" >
				...
				<div class="slider_container"  style="position:absolute;height:450px;width:100%;background">
				</div>
				<div class="reverie-header">
					<div class="row">
					<div class=" three columns">
						<h1 class="headfont"><a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><?php bloginfo('name'); ?></a></h1>
					...
					<div class="nine columns">
						<nav role="navigation">
							<?php
								...
								'link_after' => '',
								'depth' => 0,
								'items_wrap' => '<ul class="nav-bar right">%3$s</ul>',
